...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2087714852ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="254">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cus&table=projects">`cus`.`projects`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cus&table=files">`cus`.`files`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cus&table=projects_file_view">`cus`.`projects_file_view`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cus&table=projects_customers_view">`cus`.`projects_customers_view`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cus&table=projects_view">`cus`.`projects_view`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cus&table=customers">`cus`.`customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cus&table=projects_customer_file_view">`cus`.`projects_customer_file_view`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cus&table=Customers">`cus`.`Customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=jobtest&table=wp_users">`jobtest`.`wp_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=jobtest&table=wp_posts">`jobtest`.`wp_posts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5c7e4f696e53603c7d782d5c4b406960">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="254"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="cus" targettable="projects">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `projects`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="cus" targettable="files">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `files`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="cus" targettable="files">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `projects`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="cus" targettable="customers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `files`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="cus" targettable="projects_view">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `projects_view`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="cus" targettable="projects_file_view">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `projects_file_view`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="cus" targettable="projects_customers_view">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `projects_customers_view`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="cus" targettable="projects_file_view">
                            <div class="action_content">
